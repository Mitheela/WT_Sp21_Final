	...
	<form action="" method="post">
		...
		<table>
			<h1>User Information Settings</h1>
				<tr><td><Span>Change Name</Span> <input type="text" placeholder="Name" value="<?php echo $name; ?>" name="name"><br><span style="color: red;"><?php echo $err_name; ?> </span><br>
				</td>
			</tr>
<tr><td>
...
<td><input type="Password" placeholder="Confirm Password" name="cpass"><br><span style="color: red;"><?php echo $err_cpass;?></span><br></td>
</tr>

<tr>
<td><Span>Change Number</Span> <input type="number" placeholder="Number" value="<?php echo $phonenumber; ?>" name="phonenumber"><br> <span style="color: red;"><?php echo $err_phonenumber; ?> </span><br>
</td>

<td><span>Change Email Adress</span> <input type="email" placeholder="Email" value="<?php echo $email; ?>" name="email"><br><span style="color: red;"><?php echo $err_email; ?> </span><br>
                    </td>
            </tr>
<tr><td>Change Address</td></tr>
					<tr><td><span><input type="text" placeholder="Street Address" value="<?php echo $street; ?>" name="street"></span><br><span style="color: red;"><?php echo $err_street; ?></span><br>
                    <td><input type="text" placeholder="City" value="<?php echo $city; ?>" name="city"></span><br><span style="color: red;"><?php echo $err_city; ?></span><br>
                    </td>
                </tr>
				<tr>
                    <td><span> <input type="text" placeholder="State" value="<?php echo $state; ?>" name="state"></span><br><span style="color: red;"><?php echo $err_state; ?></span><br>
                    </td>
              
                    <td><span> <input type="number" placeholder="Postal/zip code" value="<?php echo $zip; ?>" name="zip"><span><br><span style="color: red;"><?php echo $err_zip; ?></span><br>
                    </td>
                </tr>
				<tr>
					<td colspan="2" align="justified"><input style="background-color:darkblue; color:white; border: 3px solid darkblue" type="submit" value="Update"></td>
				</tr>
				</table>
		</div>
	</form>
